...
@section('title','Trip Designer - Cookie Policy  - The Best Air ticket,Visa and Tour Package Service Provider in Bangladesh.')
@section('content')
    <div id="main-wrapper">
        <br>
        <br>
                    ...
                    <div class="col-xl-7 col-lg-9 col-md-12">
                        ...
                        <div class="fpc-capstion text-center my-4">
                            <div class="fpc-captions">
                                <h1 class="xl-heading text-light"> {{$c_info->name}}'s Cookie Policy</h1>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-between g-4">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="" style="text-align: justify;">
                            <h2 class="lh-base fs-1 fw-bold">Our Cookie Policy</h2>
                            {!!  json_decode($c_info->c_policy) !!}
                        </div>
                    </div>
                </div>

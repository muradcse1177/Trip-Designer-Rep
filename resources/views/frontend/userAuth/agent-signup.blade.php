...
@section('title','Trip Designer - Agent Signup  - The Best Air ticket,Visa and Tour Package Service Provider in Bangladesh.')
@section('content')
    <div id="main-wrapper">
        <br>
        <!-- End Navigation -->
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6 order-1">
                                    <div class="p-4 p-sm-7">
                                        ...
                                        @endif
                                        <!-- Form START -->
                                        {{ Form::open(array('url' => 'createNewUser',  'method' => 'post','class' => 'mt-4 text-start')) }}
                                        {{ csrf_field() }}
                                        <div class="form row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-group">
                                                    <label class="form-label">Enter Company Phone</label>
                                                    <input type="number" name="phone" class="form-control" placeholder="1707011562" maxlength="10" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Enter Company Email ID</label>

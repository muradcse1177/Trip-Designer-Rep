...
@section('title','Trip Designer - Forgot Password  - The Best Air ticket,Visa and Tour Package Service Provider in Bangladesh.')
@section('content')
    <div id="main-wrapper">
        <?php
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6 order-1">
                                    ...
                                    <div class="p-4 p-sm-7">
                                        ...
                                        @endif
                                        <!-- Form START -->
                                        {{ Form::open(array('url' => 'email-check',  'method' => 'get','class' => 'mt-4 text-start')) }}
                                        {{ csrf_field() }}
                                        <div class="form row">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary full-width font--bold btn-lg">Submit Email</button>
                                            </div>
                                        </div>
                                        {{ Form::close() }}
                                    </div>

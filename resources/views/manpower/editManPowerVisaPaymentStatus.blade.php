...
@section('title','Trip Designer || Work permit Visa Payment')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Work Permit Visa Payment Management</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Work Permit Visa Payment Management</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">Update Work Permit Visa Payment</h3>
                        ...
                        <div class="card-body" style="display: block;">
                            {{ Form::open(array('url' => 'updateManpowerVisaPaymentStatus',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                            {{ csrf_field() }}
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" name="payment_type" id="payment_type" style="width: 100%;" required>
                                            ...
                                            <option value="{{$payment_type->type}}"  @if($visa->v_p_type == $payment_type->type) Selected @endif>{{$payment_type->type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>

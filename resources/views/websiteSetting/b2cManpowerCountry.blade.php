...
@section('title','Trip Designer || ManPower country ')
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Manpower Country </h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'addManpowerCountry',  'method' => 'post' ,'class' =>'form-horizontal' ,'enctype'=>"multipart/form-data")) }}
                                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Manpower Country Management</h3>
                                <div class="card-tools">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item" href="{{url('editManpowerCountryName?id='.$country->id)}}">Edit</a>
                        ...
                        <div class="modal fade" id="modal-danger">
                            <div class="modal-dialog">
                                <div class="modal-content bg-danger">
                                    ...
                                    {{ Form::open(array('url' => 'deleteManpowerCountryName',  'method' => 'post')) }}
                                    {{ csrf_field() }}

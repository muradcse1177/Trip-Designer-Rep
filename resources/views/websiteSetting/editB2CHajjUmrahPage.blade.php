                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'editB2CHajjUmrahPackage',  'method' => 'post' ,'class' =>'form-horizontal' ,'enctype'=>"multipart/form-data")) }}
                                {{ csrf_field() }}
                                <div class="card-body row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="p_p_infant" value="{{@$package->p_p_infant}}" min="0" name="p_p_infant" placeholder="Enter Price Per Infant" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="form-group">

...
@section('title','Trip Designer || Tour Package Country ')
@section('webSettings','active')
@section('tourPackCountry','active')
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Tour Package Country </h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'addTourPackCountry',  'method' => 'post' ,'class' =>'form-horizontal' ,'enctype'=>"multipart/form-data")) }}
                                {{ csrf_field() }}
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item" href="{{url('editTourCountryName?id='.$country->id)}}">Edit</a>
                        ...
                        <div class="modal fade" id="modal-danger">
                            <div class="modal-dialog">
                                <div class="modal-content bg-danger">
                                    ...
                                    {{ Form::open(array('url' => 'deleteTourCountryName',  'method' => 'post')) }}
                                    {{ csrf_field() }}

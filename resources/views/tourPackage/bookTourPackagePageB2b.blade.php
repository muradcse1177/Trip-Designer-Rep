                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                ...
                                {{ Form::open(array('url' => 'book-tour-package-b2b',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="font12 lh-1 mb-0">
                                                    <span class="text-dark fs-3 fw-bold">
                                                        <span style="font-size: 16px; color: red;"><b>Total Fare: {{number_format((float)($package->p_p_adult*$adult + $package->p_p_child*$child), 2, '.', '')}} {{$c_info->currency}}</b></span>
                                                    </span>
                                                </p><hr>

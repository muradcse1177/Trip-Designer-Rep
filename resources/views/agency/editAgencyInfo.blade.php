                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'updateCompanyInfo',  'method' => 'post' ,'class' =>'form-horizontal' , 'enctype' => 'multipart/form-data')) }}
                                {{ csrf_field() }}
                                <div class="card-body row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Company Phone" value="{{@$company->company_pnone}}" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Company Email</label>
                                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Company Email" value="{{@$company->company_email}}" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="form-group">

...
@section('reissueAirTicket','active')
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Reissue Air Ticket</h3>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                {{ Form::open(array('url' => 'searchPNRforReissue',  'method' => 'get' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                                <div class="card-body row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="reissue" name="reissue" value="reissue" required>
                                        </div>
                                    </div>
                                </div>

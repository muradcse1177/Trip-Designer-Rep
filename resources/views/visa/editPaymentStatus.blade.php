...
@section('title','Trip Designer || Edit Visa Payment')
@section('visa','active')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Visa Payment Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Update Visa Payment</h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'updateVisaPaymentStatus',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}

...
@section('title','Trip Designer || Designation Management ')
@section('hr','active')
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'addDesignation',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item" href="{{url('editDesignationPage?id='.$designation->id)}}">Edit</a>
                                                        <a class="dropdown-item delete" data-id="{{$designation->id}}" data-toggle="modal" data-target="#modal-danger" href="{{url('deleteTourCountryName?id='.$designation->id)}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

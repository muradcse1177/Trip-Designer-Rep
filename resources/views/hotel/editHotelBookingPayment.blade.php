    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Hotel Booking Payment Management</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Hotel Booking Payment Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Update Hotel Booking Payment</h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'updateHotelBookingPaymentStatus',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="p_type" id="p_type" style="width: 100%;" required>
                                                ...
                                                @foreach($payment_types as $payment_type)
                                                    <option value="{{$payment_type->type}}"  @if($tickets->p_type == $payment_type->type) Selected @endif>{{$payment_type->type}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>

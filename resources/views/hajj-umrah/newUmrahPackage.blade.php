...
@section('title','Trip Designer || Hajj & Umrah Package')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Hajj & Umrah Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning collapsed-card">
                            <div class="card-header">
                                <h3 class="card-title">Add New Hajj & Umrah</h3>
                            ...
                            <div class="card-body" style="display: none;">
                                {{ Form::open(array('url' => 'createNewUmrahPackage',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Hajj & Umrah package Management</h3>
                                <div class="card-tools">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item" href="{{url('viewUmrahPackage?id='.$package->id)}}">View</a>
                                                        <a class="dropdown-item" href="{{url('editUmrahPackagePage?id='.$package->id)}}">Edit</a>
                                                        <a class="dropdown-item" href="{{url('editUmrahPackagePayment?id='.$package->id)}}">Edit Payment</a>
            ...
            <div class="modal fade" id="modal-danger">
                <div class="modal-dialog">
                    <div class="modal-content bg-danger">
                        ...
                        {{ Form::open(array('url' => 'deleteUmrahPackage',  'method' => 'post')) }}
                        {{ csrf_field() }}

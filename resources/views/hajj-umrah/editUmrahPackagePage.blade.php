...
@section('title','Trip Designer || Umrah Package')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Hajj & UmrahPackage Management</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Hajj & UmrahPackage Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Edit Hajj & Umrah Package</h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'updateUmrahPackage',  'method' => 'post' ,'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="country" id="country" style="width: 100%;" required>
                                                ...
                                                <option value="Umrah" <?php if($package->p_countries == 'Umrah') echo 'selected'; ?>>Umrah</option>
                                                <option value="Hajj" <?php if($package->p_countries == 'Hajj') echo 'selected'; ?> >Hajj</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
